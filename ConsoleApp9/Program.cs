...
namespace ConsoleApp5
{
    ...
    {
        public static string Pop(ref string[] massive)
        {
            string mas = massive[massive.Length - 1];
            Array.Resize(ref massive, massive.Length - 1);
            return mas;
        }
        public static int Pop(ref int[] massive1)
        {
            int mas1 = massive1[massive1.Length - 1];
            Array.Resize(ref massive1, massive1.Length - 1);
            return mas1;
        }
        public static double Pop(ref double[] massive2)
        {
            double mas2 = massive2[massive2.Length - 1];
            Array.Resize(ref massive2, massive2.Length - 1);
            return mas2;
        }
        public static decimal Pop(ref decimal[] massive3)
        {
            decimal mas3 = massive3[massive3.Length - 1];
            Array.Resize(ref massive3, massive3.Length - 1);
            return mas3;
        }
        public static float Pop(ref float[] massive4)
        {
            float mas4 = massive4[massive4.Length - 1];
            Array.Resize(ref massive4, massive4.Length - 1);
            return mas4;
        }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            decimal massive3 = ArrayHelper.Pop(ref mas3);
            ...
            int rar = ArrayHelper.Push(ref arr, "Mother");
